...
class FieldKeys(FluxQueryFunction):
    """v1.fieldKeys() returns field keys in a bucket.Results include a single table with a single column, _value.Note: FieldKeys is a special application of `tagValues that returns field
