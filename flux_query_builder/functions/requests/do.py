...
class Do(FluxQueryFunction):
    """requests.do() makes an http request.The returned response contains the following properties:(Required)
...
All values for a key will be appended to the query.
    ...
    def __init__(self, method, url, params=None, headers=None, body=None, config=None, ):
            super().__init__(method=method, url=url, params=params, headers=headers, body=body, config=config, )